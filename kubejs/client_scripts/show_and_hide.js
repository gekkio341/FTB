...
onEvent("rei.information", (event) => {
  event.addItem(["ftbstoneblock:stonepebble"], "Pebbles", ["Break Stone with your hand to get Stone Pebbles"]);
  event.addItem("ftbstoneblock:mob_soul", "Souls", ["Has an 80% chance of spawning every time a mob dies."]);
  event.addItem("ftbstoneblock:ritual_starter", "Rituals", ["Can be found in End City structures."]);
  event.addItem("ftbstoneblock:cold_silverfish_shard", "Cold Silverfish Shard", [
    "Can be found in dungeons in the stone area.",
  ]);
  event.addItem("ftbstoneblock:warm_silverfish_shard", "Warm Silverfish Shard", [
