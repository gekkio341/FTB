onEvent('rei.information', (event) => {
	...
	event.addItem(["ae2:inscriber", "ae2things:advanced_inscriber"],
		'Inscribers',
		[
			Text.red("Inscribers have been disabled and replaced with Create Sequenced Crafting."),
			Text.red("If you already have one, it will still work, but you can't craft any more."),
		]
	)
	...
	event.addItem(Item.of('chickens:chicken_item', '{ChickenType:{id:"chickens:smart_chicken"}}'),
		'Smart Chickens',
		[
			'Spawn by using a Book on a normal Chicken',
			' ',
